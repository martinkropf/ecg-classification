function [result,dataPerBeat] = ait_challenge(recordName,pars,model)
%
...
% 	recordName='C:\temp\cinc2017\A00147';% N mit QRS auf T
%  	recordName='C:\temp\cinc2017\A00172';% N mit QRS auf T
	recordName='C:\temp\cinc2017\A00027';% AF mit Ectopic beats
% 	recordName='C:\temp\cinc2017\A03994';% O
%  	recordName='C:\temp\cinc2017\A00004';% AF
% 	recordName='C:\temp\cinc2017\A00005';% O
% 	recordName='C:\temp\cinc2017\A00205';% ~
%  	recordName='C:\temp\cinc2017\A00056';% ~
% 	recordName='C:\temp\cinc2017\A00058';% O
%  	recordName='C:\temp\cinc2017\A00052';% N
%  	recordName='C:\temp\cinc2017\A00069';% O
% 	recordName='C:\temp\cinc2017\A00286';% O
% 	recordName='C:\temp\cinc2017\A00077';% O
end
...
cell_data={...
		...
		rhythm_res.sc_2,...
		rhythm_res.sc_3,...
		rhythm_res.longestNormalSeq,...
		rhythm_res.n_premajure,...
		rhythm_res.Nectopic,...
		rhythm_res.nOPatterns_2letters,...
		rhythm_res.nOPatterns_3letters,...
		rhythm_res.nOPatterns_4letters,...
		rhythm_res.nPattern_AD_in_Ns,...
		rhythm_res.NPa,...
		rhythm_res.NPv,...
		rhythm_res.NPc,...
		rhythm_res.NPz,...
...
for i=1:6
	cell_data{end+1}=eval(['af_res.p_af_freq_rel_',int2str(i)]);
end
for i=1:6
	cell_data{end+1}=eval(['noise_res.p_freq_rel_',int2str(i)]);
end

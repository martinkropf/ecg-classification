...
% GSc 2016-10-14 replaced nargchk by narginchk
% CHECK
% ------------------------------------------------------------------------

try % GSc 2015-07-11 for usage as a feature in predictive modelling
...
%        warning('warnginicoeff:negValues','Check IDX for negative values or one-element series')
    ...
    coeff = NaN;
%    warning('warnginicoeff:negValues','Check for empty series')
